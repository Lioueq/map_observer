...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.label_address, 4, 0, 1, 7)
        self.btn_change_map = QtWidgets.QPushButton(self.centralwidget)
        self.btn_change_map.setObjectName("btn_change_map")
        self.gridLayout.addWidget(self.btn_change_map, 2, 6, 1, 1)
        self.btn_postal_code = QtWidgets.QPushButton(self.centralwidget)
        self.btn_postal_code.setObjectName("btn_postal_code")
        self.gridLayout.addWidget(self.btn_postal_code, 2, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_error_msg, 2, 2, 1, 2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_postal_code.setText(_translate("MainWindow", "Индекс"))
